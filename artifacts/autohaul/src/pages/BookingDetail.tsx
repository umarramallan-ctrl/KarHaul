              ...
              <div className="space-y-6">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-amber-800 dark:text-amber-400"><strong>Payment Reminder:</strong> AutoHaul Connect does not process payments. Payment terms are arranged directly between shipper and carrier.</p>
                  </div>
                </div>
              </div>
            </div>
