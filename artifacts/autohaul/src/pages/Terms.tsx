        ...
        <main className="flex-1 min-w-0 prose dark:prose-invert max-w-none prose-headings:font-display prose-h2:text-xl prose-h3:text-base">
          ...
          {active === "Terms of Service" && (
            <>
              ...
              <p>KarHaul charges a <strong>5% platform fee to Shippers</strong> and a <strong>3% platform fee to Drivers</strong>, both calculated on the Shipper's maximum budget. The Shipper fee is collected in escrow when posting a load; the Driver fee is collected in escrow when a bid is accepted. Both fees are released to KarHaul upon delivery confirmation and are clearly displayed before any commitment. The platform fee does not cover the cost of transport, insurance, fuel, or any aspect of the physical move — it covers access to the Platform's technology, matching infrastructure, messaging system, and tracking features.</p>
          ...
          {active === "Liability Waiver" && (
            <>
              ...
              <div className="not-prose bg-red-50 dark:bg-red-950/30 p-5 rounded-lg border border-red-200 dark:border-red-900 mb-6">
                ...
                <p className="text-sm text-red-800 dark:text-red-300">
                  BY USING KARHAUL, YOU EXPLICITLY ACKNOWLEDGE AND AGREE THAT KARHAUL HOLDS ZERO LIABILITY FOR ANY ASPECT OF THE PHYSICAL TRANSPORTATION OF VEHICLES ARRANGED THROUGH THE PLATFORM. ALL TRANSPORT LIABILITY EXISTS STRICTLY BETWEEN THE SHIPPER AND THE CARRIER.
                </p>
              </div>
