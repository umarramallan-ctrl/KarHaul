        ...
        <main className="flex-1 min-w-0 prose dark:prose-invert max-w-none prose-headings:font-display prose-h2:text-xl prose-h3:text-base">
            ...
            <>
              ...
              <div className="not-prose bg-red-50 dark:bg-red-950/30 p-5 rounded-lg border border-red-200 dark:border-red-900 mb-6">
                ...
                <p className="text-sm text-red-800 dark:text-red-300">
                  These Terms of Service constitute a legally binding agreement between you and EvoHaul. By creating an account or using the Platform, you agree to these Terms in their entirety. If you do not agree, you must not use the Platform.
                </p>
              </div>

              <h3>1. About EvoHaul</h3>
              <p>
                EvoHaul ("Platform," "we," "our," "us") is a technology marketplace operated at evohaul.com that allows individuals and businesses ("Shippers") to post vehicle transport requests and independent licensed motor carriers ("Carriers" or "Drivers") to submit bids on those requests. <strong>EvoHaul is not a motor carrier, freight broker, freight forwarder, or transportation provider of any kind.</strong> We do not employ drivers, own vehicles, dispatch transport, or handle freight.
              </p>
              ...
              <p>You agree to provide accurate, current, and complete information during registration and to keep your account information updated. You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. Notify us immediately at support@evohaul.com if you suspect unauthorized access. We offer two-factor authentication (TOTP and SMS) and passkey authentication — we strongly recommend enabling these for your security.</p>

              <h3>4. Platform Fees</h3>
              <p>EvoHaul charges a <strong>3% service fee to Shippers only</strong>, calculated on the agreed transport price at the time a bid is accepted. This fee is clearly displayed before acceptance. Carriers and Drivers pay no fees to use the Platform. The platform fee does not cover the cost of transport, insurance, fuel, or any aspect of the physical move — it covers access to the Platform's technology, matching infrastructure, messaging system, and tracking features.</p>

              <h3>5. Transport Transactions</h3>
              <p>All transport agreements are made directly between the Shipper and the Carrier. EvoHaul does not process, hold, or guarantee any payments for transport services. Payment terms, methods, and schedules must be negotiated and agreed upon by the transacting parties using the Platform's messaging system or in the Bill of Lading. EvoHaul has no obligation to resolve payment disputes between users.</p>
              ...
              <p>We may suspend or terminate your account at any time for violation of these Terms, fraudulent activity, or conduct we deem harmful to the Platform or its users. You may close your account at any time by contacting support@evohaul.com. Termination does not relieve you of any obligations incurred before the termination date.</p>

              <h3>18. Contact</h3>
              <p>Questions about these Terms should be directed to legal@evohaul.com.</p>
            </>
          )}
          ...
          {active === "Liability Waiver" && (
            <>
              ...
              <p>EvoHaul is a neutral technology marketplace. We provide software tools to connect shippers with carriers. We are not a party to any transport transaction. We do not:</p>
              <ul>
              ...
              <p>
                EvoHaul expressly disclaims all liability for damage to vehicles during loading, transport, unloading, or storage. This includes but is not limited to: scratches, dents, mechanical damage, theft, total loss, weather damage, or fire. All claims for vehicle damage must be filed directly with the Carrier's cargo insurance provider. A properly executed and notated Bill of Lading is required for any valid cargo insurance claim.
              </p>

              <h3>3. Carrier Performance Disclaimer</h3>
              <p>
                EvoHaul does not guarantee that any Carrier will: perform the transport as agreed, arrive on time, maintain adequate insurance at the time of transport, or honor any verbal or written commitment. Users accept that carrier interactions carry inherent risk and that the Platform's Verified badge reflects a one-time credential check, not ongoing real-time compliance monitoring.
              </p>

              <h3>4. Payment Dispute Disclaimer</h3>
              <p>
                EvoHaul does not hold, process, or escrow any transport payments. All payment disputes are strictly between Shippers and Carriers. EvoHaul will not intervene in, mediate, or compensate for any financial dispute arising from a transport transaction.
              </p>

              <h3>5. Shipper Waiver of Claims Against Platform</h3>
              <p>
                By accepting a carrier's bid and proceeding with transport through the Platform, Shippers irrevocably waive any and all claims against EvoHaul arising from: vehicle damage, late delivery, carrier failure, payment disputes, misrepresentation by carriers, or any other event related to the transport. This waiver is a condition of using the Platform.
              </p>

              <h3>6. Carrier Waiver of Claims Against Platform</h3>
              <p>
                By using the Platform to find and accept transport work, Carriers irrevocably waive any and all claims against EvoHaul arising from: shipper payment disputes, shipper misrepresentation of vehicle condition, unreimbursed transport costs, or any loss incurred in the performance of transport services.
              </p>

              <h3>7. Force Majeure</h3>
              <p>
                Neither EvoHaul nor Carriers shall be held liable for delays or failures caused by events outside their reasonable control, including but not limited to: natural disasters, severe weather, road closures, government actions, pandemics, labor disputes, or civil unrest. Shippers acknowledge that transport timelines are estimates subject to such events.
              </p>

              <h3>8. Indemnification Obligations</h3>
              <p>
                Both Shippers and Carriers agree to indemnify, defend, and hold EvoHaul and its affiliates, officers, directors, and employees harmless from and against any claims, damages, liabilities, costs, and expenses (including attorney's fees) arising from their use of the Platform, their transport transactions, their breach of these Terms, or their violation of any applicable law or regulation.
              </p>
          ...
          {active === "Privacy Policy" && (
            <>
              ...
              <h3>Your Rights</h3>
              <p>You can access, update, export, or delete your data. California residents have CCPA rights; EEA residents have GDPR rights. Contact privacy@evohaul.com.</p>
          ...
          {active === "Carrier Requirements" && (
            <>
              ...
              <p>EvoHaul recommends that shippers check carrier FMCSA Safety Ratings before contracting for transport. Ratings include:</p>
              <ul>
              ...
              <p>Carriers with Unsatisfactory safety ratings are not permitted to use the EvoHaul platform.</p>
          ...
          {active === "Cookie Policy" && (
            <>
              ...
              <p>
                This Cookie Policy explains how EvoHaul uses cookies and similar technologies when you visit evohaul.com. By using the Platform, you consent to our use of cookies as described in this policy.
              </p>
              ...
              <p>EvoHaul does <strong>not</strong> use:</p>
              <ul>
              ...
              <h3>7. Contact</h3>
              <p>
                Questions about this Cookie Policy: privacy@evohaul.com
              </p>
            </>
          )}
        </main>
