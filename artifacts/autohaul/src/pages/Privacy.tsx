  ...
  return (
    <MainLayout>
      <div className="container max-w-4xl mx-auto px-4 py-12 prose dark:prose-invert prose-headings:font-display">
        ...
        <p>
          We may disclose your information if required to do so by law, regulation, or valid legal process (such as a court order or subpoena), or if we believe in good faith that disclosure is necessary to protect the rights, property, or safety of AutoHaul Connect, our users, or the public.
        </p>
        ...
        <p>You may request a copy of the personal data we hold about you by contacting us at privacy@autohaulconnect.com. We will provide the data in a commonly used, machine-readable format within 30 days.</p>

        <h3>6.3 Deletion</h3>
        <p>You may request deletion of your account and associated personal data by contacting support@autohaulconnect.com. We will process your request within 30 days, subject to any legal retention obligations.</p>
        ...
        <p>
          California residents have additional rights under the California Consumer Privacy Act (CCPA), including the right to know what personal information is collected, the right to delete personal information, and the right to opt out of the sale of personal information (which we do not conduct). To exercise these rights, contact us at privacy@autohaulconnect.com.
        </p>

        <h3>6.6 European Economic Area Residents (GDPR)</h3>
        <p>
          If you are located in the EEA, you have rights under the General Data Protection Regulation (GDPR) including the right to access, rectify, erase, restrict processing, and port your personal data, as well as the right to object to processing based on legitimate interests. Our legal basis for processing is your consent (account creation), contract performance (providing marketplace services), and legitimate interests (security, fraud prevention, platform improvement). Contact us at privacy@autohaulconnect.com to exercise these rights.
        </p>
        ...
        <p>
          AutoHaul Connect is not directed to individuals under the age of 18. We do not knowingly collect personal information from minors. If we become aware that a minor has created an account, we will terminate the account and delete the associated data promptly. If you believe a minor has submitted personal information, contact us at privacy@autohaulconnect.com.
        </p>
        ...
        <ul>
          <li><strong>Email:</strong> privacy@autohaulconnect.com</li>
          <li><strong>Support:</strong> support@autohaulconnect.com</li>
          <li><strong>Support Center:</strong> <a href="/support">autohaulconnect.com/support</a></li>
        </ul>
        <p>
