...
const FAQS: Record<string, FaqItem[]> = {
  "Shippers": [
    ...
    },
    {
      ...
      a: "AutoHaul Connect charges a single 3% service fee to shippers on the agreed transport price. This fee covers platform maintenance, identity verification of carriers, secure messaging, milestone tracking, and in-app communication tools. There are no hidden fees, subscriptions, or broker markups. Drivers pay nothing to use the platform.",
    },
    {
      q: "How and when do I pay the carrier?",
      a: "Payment is arranged directly between you and the carrier — AutoHaul Connect does not process or hold transport payments. Most carriers accept cash on delivery, Zelle, wire transfer, or certified check. Always agree on payment terms in writing (via in-app messages) before pickup. The 3% platform fee is noted on your booking confirmation.",
    },
    {
    ...
    },
    {
      ...
      a: "Contact the carrier directly via the in-app call button or messaging. If you cannot reach them, you may cancel the booking and relist your shipment. AutoHaul Connect does not guarantee carrier performance — always vet carriers carefully and avoid paying any deposit before pickup without written confirmation.",
    },
  ],
  "Carriers & Drivers": [
    {
      q: "Is it free for drivers to use AutoHaul Connect?",
      a: "Yes — completely free. AutoHaul Connect charges zero fees to carriers or drivers. You can browse loads, submit bids, communicate with shippers, and manage bookings at no cost. The platform's 3% fee is charged to the shipper only.",
    },
    {
      ...
      <div className="bg-gradient-to-b from-primary/5 to-transparent py-14 border-b">
        <div className="container max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Find answers, learn about safety requirements, or reach out to the AutoHaul Connect team.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
              {[
                ...
                { icon: AlertTriangle, title: "Damage Claims", desc: "File directly with the carrier's cargo insurance — not AutoHaul Connect.", color: "text-amber-600 bg-amber-50" },
              ...
              <Card>
                <CardContent className="pt-5 space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">support@autohaulconnect.com</p>
