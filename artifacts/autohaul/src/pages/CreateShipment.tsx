                            ...
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                              ...
                              <div className="space-y-1 leading-tight">
                                ...
                                <FormDescription className="text-red-800/80 dark:text-red-400/80 text-xs">
                                  I acknowledge that EVAUL is a technology platform connecting independent parties. The platform takes no fee and assumes ZERO LIABILITY for vehicle damage, delays, driver no-shows, or payment disputes. All contracts and payments are strictly between the shipper and the carrier.
                                </FormDescription>
                              </div>
                            </FormItem>
                          )} />
