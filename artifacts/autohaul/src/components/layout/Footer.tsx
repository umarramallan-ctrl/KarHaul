    ...
    <footer className="bg-slate-900 text-slate-300 py-12 border-t border-slate-800">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/terms?section=Liability+Waiver" className="hover:text-white transition-colors">Liability Waiver</Link></li>
              <li><Link href="/privacy" className="hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms?section=Carrier+Requirements" className="hover:text-white transition-colors">Carrier Requirements</Link></li>
              <li><Link href="/terms?section=Cookie+Policy" className="hover:text-white transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} Traxion. All rights reserved.</p>
          <p className="text-xs max-w-xl text-center md:text-right">
            Traxion is a technology platform, not a motor carrier or freight broker.
