...
// TODO: Switch to sk_live after Beta complete.
export const stripe = new Stripe(stripeKey ?? "sk_test_placeholder", {
  apiVersion: "2025-02-24.acacia",
});

export const SHIPPER_FEE_PERCENT = 0.05; // 5% of agreed bid
export const DRIVER_FEE_PERCENT = 0.03;  // 3% of agreed bid
 ...
 */
export function computeEscrowAmounts(price: number | null | undefined) {
  const base = price ?? 0;
  return {
