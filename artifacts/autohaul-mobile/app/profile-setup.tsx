        ...
        {!(profile as any)?.termsAccepted && (
          ...
          >
            ...
            <Text style={[styles.termsText, { color: C.textSecondary }]}>
              I agree to the <Text style={{ color: C.primary }}>Terms of Service</Text>. I understand KarHaul is a marketplace only and assumes no liability for transport, damages, or disputes between shippers and drivers.
            </Text>
          </Pressable>
        )}
      </ScrollView>
