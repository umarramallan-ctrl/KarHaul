          ...
          <ScrollView contentContainerStyle={{ padding: 20, gap: 16 }}>
            ...
            <View style={[styles.disclaimerBox, { backgroundColor: "#FEF9C3", borderColor: "#FDE68A" }]}>
              ...
              <Text style={{ fontFamily: "Inter_400Regular", fontSize: 12, color: "#A16207", flex: 1, lineHeight: 18 }}>
                By bidding, you agree to transport this vehicle if accepted. Payment is arranged directly with the shipper. AutoHaul Connect is not responsible for disputes.
              </Text>
            </View>
            <Pressable
